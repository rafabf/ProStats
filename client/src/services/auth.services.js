...
export default class Services {
    ...
    signup = ({ username, password }) => this.service.post('/signup', { username, password }).then(response => response.data).catch(err => console.log({ err }, "error de crear usuario en service"))
